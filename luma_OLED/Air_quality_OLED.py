...
#This python code uses the Bme680 sensor to show the air_quality in the sh1107 OLED screen. 
#The sensor has to burn during 5 minutes before show the quality index in the screen.
     ...
     if sensor.get_sensor_data() and sensor.data.heat_stable:
        ...
        while True:
            ...
            with canvas(device) as draw:
                ...
                draw.text((4, 48), "air quality:  ", fill="white", font=FontTemp2)
                draw.text((5, 77), f"{air_quality_score:.2f}", fill="white", font=FontTemp2)
